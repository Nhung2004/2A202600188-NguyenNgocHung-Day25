...
class CircuitBreaker:
    ...
    def allow_request(self) -> bool:
        ...
        When OPEN, check if timeout elapsed to transition to HALF_OPEN.
        In HALF_OPEN, allow one probe at a time.
        """
    ...
    def record_success(self) -> None:
        ...
        if self.state == CircuitState.HALF_OPEN:
            ...
            self.success_count = 0  # Reset success count in CLOSED state if needed
